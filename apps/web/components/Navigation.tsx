...
const navigation=['Decisions','Weekly Review','Memory Inbox','Permissions'];
export type NavigationCurrent='today'|'ask'|'devices'|'sources'|'connectors'|'jobs'|'registry'|'merge-split'|'commitments'|'obligations'|null;
